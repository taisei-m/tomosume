			...
			<Card containerStyle={styles.card}>
				...
				<View style={styles.actionButtons}>
					<View style={styles.actionButtonsLeft}>
						<View>
							<Icon size={30} name="heart" type="font-awesome" color="red" />
						</View>
						<View style={styles.actionButtonSearch}>
							<Icon size={30} name="search" type="font-awesome" color="black" />
						</View>
					</View>
					<View style={styles.actionButtonsRight}>
						<View>
							<Icon size={30} name="inbox" type="font-awesome" color="black" />
						</View>
					</View>
				</View>
				<TouchableOpacity>
