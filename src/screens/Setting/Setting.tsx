...
const Setting: React.FC<ProfileStackNavProps<"setting"> & ContainerProps> = (
  props
) => {
...
export const SettingWrapper: React.FC<ProfileStackNavProps<"setting">> = ({
  navigation
}) => {
  return (
