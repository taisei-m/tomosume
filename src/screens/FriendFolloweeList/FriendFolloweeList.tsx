...
const FolloweeList:React.FC<TopStackNavProps<'friendFolloweeList'> & ContainerProps> = (props) => {
    ...
    useEffect(() => {
        (async () => {
            ...
            const checkedFollowExchangeArray =  await checkFollowExchange(props.globalState.state.uid, friendFolloweeDescriptions)
