...
const Post: React.FC<NavigationProps & GlobalStateProps> = (props) => {
	...
	return (
		<KeyboardAwareScrollView style={{ flex: 1, backgroundColor: 'white' }}>
				...
				<View>
					...
					<View style={{ flexDirection: 'row', width: 250, alignContent: 'center' }}>
						...
						<Button
							...
							disabledStyle={canPressSearchButton ? { backgroundColor: 'white' } : null}></Button>
					</View>
				</View>
				{isShownPredictions ? (
					<KeyboardAwareScrollView style={{ flex: 1, backgroundColor: 'white' }}>
			...
			<View>
				<Dialog visible={_dialogVisible} onTouchOutside={closeDialob}>
					<View>
			...
			<View>
				<Dialog visible={shareCompleteDialogVisible} onTouchOutside={closeShareCompleteDialog}>
					<View>
			...
			<View>
				<Dialog visible={permissionDialogVisible} onTouchOutside={closePermissionDialog}>
					<View>
